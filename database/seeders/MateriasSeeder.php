...
class MateriasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/1.svg'
        ]);
        ...
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/2.svg'
        ]);
        ...
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/3.svg'
        ]);
        ...
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/4.svg'
        ]);        
        ...
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/5.svg'
        ]);
        ...
        DB::table('materias')->insert([
            ...
            'img_link' => 'imgs/svg/materia/6.svg'
        ]);
